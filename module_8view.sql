...
INSERT INTO employees3 (emp_id, name, department, salary)
VALUES 
...
INSERT INTO employees2(emp_id, name, department,
 salary,dept_id)
VALUES 
(110, 'Diana Clark', 'it', 72000.00,12);


CREATE VIEW it_view3 AS
SELECT emp_id, name, department, salary
FROM employees3 where department='it';
...
ALTER VIEW it_view3 AS
SELECT emp_id, name, salary 
FROM employees3 WHERE salary < 50000;

select * from it_view3;


--  Drop View
DROP VIEW emp_view,it_view3;
...
CREATE USER 'shubham_user'@'localhost' IDENTIFIED BY '1234567';

use view_demo;



GRANT SELECT ON it_view1 TO 'shubham_user'@'localhost';
